...
const GradientBtn = ({ title, className }) => {
  return (
    <button
      className={`bg-gradient-to-br from-orange-500 via-black to-green-500 text-gray-300 px-7 py-2 text-xl rounded-3xl font-medium focus:ring ring-black ring-opacity-10 gradient element-to-rotate ${className}`}
    >
      {title}
    </button>
  );
