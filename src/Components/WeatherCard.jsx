...
//           Weather Description
//         </div>
//         <div className="temp text-3xl text-white">25°C</div>
//         <div className="minmaxContainer w-full flex items-center justify-between">
//           <div className="min w-1/2 flex flex-col items-end justify-center pr-5 space-y-1">
//             <div className="minHeading text-xs font-semibold text-white">
//               Min
//             </div>
//             <div className="minTemp text-xs font-medium text-gray-400">
//               15°C
//             </div>
//           </div>
//           <div className="max w-1/2 flex flex-col items-start justify-center pl-5 border-l border-white">
//             <div className="maxHeading text-xs font-semibold text-white">
//               Max
//             </div>
//             <div className="maxTemp text-xs font-medium text-gray-400">
//               30°C
//             </div>
//           </div>
//         </div>
